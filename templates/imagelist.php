...
?>
<?php 
function templateImageList($miwImages) { // DO NOT TOUCH
    $content = null; // DO NOT TOUCH
    $hdContent = null; // DO NOT TOUCH
foreach ($miwImages as $miwImage) { // DO NOT TOUCH
    $hdContent = // DO NOT TOUCH
<<<END
<p>&nbsp;</p>
<p>{$miwImage['html_blurb_before']}</p>
<p>&nbsp;</p>
<p><a title="Mythical Beast Wars - {$miwImage['title']}" rel="lightbox" href="{$miwImage['original_src']}" style="border: 0px none;">
        <span style="{$miwImage['place_image_css']} background-image: url('{$miwImage['place_image_src']}');"></span>
        <img style="padding:0px;border: 4px double #000; outline: 1px solid #000;outline-offset: -2px;" width="{$miwImage['medium_width']}" height="{$miwImage['medium_height']}" alt="Mythical Beast Wars - {$miwImage['title']}" src="{$miwImage['medium_src']}" title="Mythical Beast Wars - {$miwImage['title']}" class="alignnone size-full wp-image-699"/>
    </a></p>
<p><img width="115" height="75" alt="" src="http://mythicalbeastwars.com/wp-content/uploads/2012/02/number{$miwImage['entry_number_padded']}.jpg" title="number{$miwImage['entry_number']}" style="margin-left: 10px; margin-right: 10px;" class="alignleft size-full"/>
{$miwImage['html_blurb_after']}
<p><strong><br>
</strong></p>
<p></p>
<p></p>
<p>&nbsp;</p>
END;
    $content = $content.$hdContent; // DO NOT TOUCH
} // End of for loop DO NOT TOUCH
return $content; // DO NOT TOUCH
} // End of template DO NOT TOUCH
?>
